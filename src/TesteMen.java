...
public class TesteMen {
    ...
    public static void testaLocali() {
        System.out.println("-----Teste de locali----");
        ...
        try {
            ...
            String[] res = mRegistro.procurar("34.041.258/0001-58", "adm", "123");
            ...
            Logger.getLogger(TesteMen.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(TesteMen.class.getName()).log(Level.SEVERE, null, ex);
        }
